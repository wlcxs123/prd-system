...
var CONFIG = {
    ...
    TEMP_BASE_URL: (function() {
        ...
        if (isLocal) {
            ...
            // 生产环境 - 使用8080端口
            return 'http://115.190.103.114:8080';
        }
    })(),
    ...
    detectEnvironment: function() {
        ...
        return {
            ...
            baseUrl: isLocal ? 'http://127.0.0.1:5002' : 'http://115.190.103.114:8080'
        };
    },
    ...
    init: async function() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('CONFIG initialized from server:', {
                ...
                this.BASE_URL = envInfo.baseUrl;
                this.ENVIRONMENT = envInfo.isLocal ? 'local' : 'production';
